...
grep -q "default: '1.2.1'" action.yml
grep -q '1.2.1/amd64' scripts/github-install.sh
grep -q '1.2.1/arm64' scripts/github-install.sh
...
test -s "$tmp/pass/artifacts/handoff-preview.json"
